...
const SupportWhatsAppButton = () => {
  ...
  return (
    <>
      {/* Tooltip */}
      <div
        className={`fixed z-[1000] right-[84px] bottom-[114px] transition-all duration-300 ease-in-out px-4 py-2 bg-white text-gray-800 rounded-lg shadow-lg font-medium text-sm whitespace-nowrap hidden md:block border border-gray-100 ${
          isHovered
